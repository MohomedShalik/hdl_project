...
HD_PWD='/home/halaldeen-ms/Dev/gaussian_filter/gaussian_filter.runs/adder_12b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_12b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_12b.tcl
