...
HD_PWD='/home/halaldeen-ms/Dev/gaussian_filter/gaussian_filter.runs/adder_15b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_15b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_15b.tcl
