...
HD_PWD='/home/halaldeen-ms/Dev/gaussian_filter/gaussian_filter.runs/fifo_us_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_us.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_us.tcl
