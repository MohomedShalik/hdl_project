...
HD_PWD='/home/halaldeen-ms/Dev/gaussian_filter/gaussian_filter.runs/adder_14b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_14b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_14b.tcl
