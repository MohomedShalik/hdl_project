...
#
# Generated by export_simulation on Sun Oct 24 17:39:40 +0530 2021
#
################################################################################
...
'-reset_run' switch to the './multiplier.sh' script.

./multiplier.sh -reset_run
...
./multiplier.sh -noclean_files

For more information on the script, please type './multiplier.sh -help'.
